...
var file_rpc_healthcheck_proto_rawDesc = []byte{
	...
	0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x0d, 0x0a, 0x0b, 0x50,
	...
	0x73, 0x61, 0x67, 0x65, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x67, 0x61, 0x74,
...
var file_rpc_healthcheck_proto_goTypes = []interface{}{
...
func file_rpc_healthcheck_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_healthcheck_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_healthcheck_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
